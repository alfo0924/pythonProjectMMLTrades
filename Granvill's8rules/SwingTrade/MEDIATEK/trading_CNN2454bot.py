...
fig.update_layout(title='聯發科 2454 交易策略 (卷積神經網絡 CNN + 均線:200均 交易頻率:一周一次)', xaxis_title='日期', yaxis_title='價格', showlegend=True)
...
# 寫入HTML文件
with open("trading_Granvills8rules_2454_CNN_result_weekly.html", "w", encoding="utf-8") as file:
    file.write(html_content)

# 打開瀏覽器顯示結果
webbrowser.open("trading_Granvills8rules_2454_CNN_result_weekly.html")
