...
fig.update_layout(title='黃金 GC=F 交易策略 (長短期記憶網路 LSTM  + 每周一次波段移動平均線策略)', xaxis_title='日期', yaxis_title='價格', showlegend=True)
...
# 寫入HTML文件
with open("trading_LSTMGOLDresult_weekly.html", "w", encoding="utf-8") as file:
    file.write(html_content)

# 打開瀏覽器
webbrowser.open("trading_LSTMGOLDresult_weekly.html")
