...
fig.update_layout(title='BTC-USD 交易策略 (長短期記憶網路 LSTM  + 波段移動平均線策略 頻率:每周交易一次)', xaxis_title='日期', yaxis_title='價格', showlegend=True)
...
# 寫入HTML文件
with open("trading_LSTMBTCUSDresult.html", "w", encoding="utf-8") as file:
    file.write(html_content)

# 打開瀏覽器
webbrowser.open("trading_LSTMBTCUSDresult.html")
