...
fig.update_layout(title='台積電 2330 交易策略 (遞歸神經網絡 RNN + 格蘭碧8大法則 均線:200均 交易頻率:一天多次 )', xaxis_title='日期', yaxis_title='價格', showlegend=True)
...
# 寫入HTML文件
with open("trading_Granvills8rules_2330_RNN_result.html", "w", encoding="utf-8") as file:
    file.write(html_content)

# 打開瀏覽器
webbrowser.open("trading_Granvills8rules_2330_RNN_result.html")
