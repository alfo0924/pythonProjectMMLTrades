...
fig.update_layout(title='聯發科 2454 交易策略 (隨機森林 RF 自主學習 無任何自定義交易策略框架 交易頻率: 每周交易一次)', xaxis_title='日期', yaxis_title='價格', showlegend=True)
...
# 寫入HTML文件
with open("trading_2454_RF_autonomous_weekly_result.html", "w", encoding="utf-8") as file:
    file.write(html_content)

# 打開瀏覽器
webbrowser.open("trading_2454_RF_autonomous_weekly_result.html")
